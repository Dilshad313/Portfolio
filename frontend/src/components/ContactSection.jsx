          ...
          <div className="bg-card/50 p-8 rounded-xl shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-medium text-lg text-left">Phone</h4>
                  <a
                    href="tel:+918129645054"
            ...
            {/* Social Links */}
            <div className="pt-10">
              <h4 className="font-medium mb-4 text-lg text-center md:text-left">
                Connect With Me
              </h4>
              <div className="flex justify-center md:justify-start space-x-4">
                <a
                  href="https://www.linkedin.com/in/dilshad-k-66a9a5321/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/dilshad_mkd_3048/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 transition-colors"
                >
